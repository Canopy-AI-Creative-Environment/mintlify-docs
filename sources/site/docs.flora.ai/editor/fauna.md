# Source: https://docs.flora.ai/editor/fauna

For the complete documentation index, see [llms.txt](https://docs.flora.ai/llms.txt). This page is also available as [Markdown](https://docs.flora.ai/editor/fauna.md).
...
- Fill out this short survey: [https://tally.so/r/XxJboL](https://tally.so/r/XxJboL)
...
[PreviousCollaboration & Sharing](https://docs.flora.ai/editor/collaboration-and-sharing) [NextElements](https://docs.flora.ai/editor/elements)
